...
def test_continuousEpdUpdateLoop_skips_display_during_quiet_hours():
    """During quiet hours, the loop skips display without calling fetchImageFromUrl."""
    ...
    with (
        ...
        continuousEpdUpdateLoop(
            ...
            "http://example.com",
            alarmMinutes=0,
            quietConfig={"start": "22:00", "end": "07:00"},
        )
